class Board:
    """Klasa rysująca planszę Sudoku i walidująca pojedyncze komórki."""
    ...
    def get_val(self, row: int, col: int) -> str:
    ...
    def _is_valid(self, row: int, col: int) -> bool:
        """Sprawdza błędy w wierszach i kolumnach."""
    ...
    def __str__(self) -> str:
        """Drukuje sformatowaną, kolorową planszę w terminalu."""
        RED = '\033[91m'
        GREEN = '\033[92m'
        RESET = '\033[0m'
