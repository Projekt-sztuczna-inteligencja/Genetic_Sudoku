    ...
    def generate(self, target_difficulty: str = "MEDIUM") -> list[int]:
        ...
        while True:
            ...
            if current_level == target_level:
                ...
                diff_str = current_report.split()[0]
                print(f"⚠️ Próba {attempts} zakończona na {diff_str}. To za łatwe. Próbuję od nowa...\n")
...
if __name__ == "__main__":
    ...
    final_puzzle = factory.generate(target_difficulty="EVIL")
